        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('surat-keluar.admin.update', $suratKeluar->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <!-- No Surat -->
                        <div class="mb-4">
                            <label for="nomor_surat" class="block text-sm font-medium text-gray-700">Nomor surat</label>
                            <input type="text" id="nomor_surat" name="nomor_surat" value="{{ $suratKeluar->nomor_surat }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="pengirim" name="pengirim" value="{{ $suratKeluar->pengirim }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="penerima" name="penerima" value="{{ $suratKeluar->penerima }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="perihal" name="perihal" value="{{ $suratKeluar->perihal }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" id="tanggal_surat" name="tanggal_surat" value="{{ $suratKeluar->tanggal_surat }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200"
                                required>
                            @error('tanggal_surat')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" id="tanggal_terima" name="tanggal_terima" value="{{ $suratKeluar->tanggal_terima }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200"
                                required>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="kategori_surat_id" name="kategori_surat_id"
                                ...
                                <option value="{{ $kategori->id }}" {{ $suratKeluar->kategori_surat_id == $kategori->id ? 'selected' : '' }}>{{ $kategori->nama_kategori }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="status" name="status"
                                ...
                                <option value="diterima" {{ old('status', $suratKeluar->status ?? '') == 'diterima' ? 'selected' : '' }}>Diterima</option>
                            ...
                            <div class="my-4">
                                ...
                                <textarea id="isi_ringkas" name="isi_ringkas"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200"
                                    placeholder="Masukkan Isi Ringkas Surat" required>{{ $suratKeluar->isi_ringkas }}</textarea>
                                @error('isi_ringkas')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
